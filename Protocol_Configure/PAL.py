...
class Experiment_Configuration():
    def __init__(self,root_screen):
        ...
        self.title = tk.Label(self.main_run,text='PAL Protocol Setup')
        ...
        self.trial_max_input.insert(tk.END,'72')
        ...
        self.block_length_input.insert(tk.END,'24')
    ...
    def start_protocol(self):
        ...
        pr.Route_Switch('PAL',self.parameters)
