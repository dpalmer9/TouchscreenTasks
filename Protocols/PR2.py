...
class Experiment_Staging(FloatLayout):
    def __init__(self,session_max,reward_type,id_entry,**kwargs):
    ...
    def id_setup(self):
        ...
        self.data_col_names = 'TrialNo, Current Reward, Current Threshold, X_Position, Y_Position, Latency, Time of Press'
    ...
    def sample_pressed(self,*args):
        self.sample_press_time = self.time_elapsed
    ...
    def record_data(self):
        ...
        self.data_file.write("%s,%s,%s,%s,%s,%s,%s" % (self.current_trial,self.current_reward_size,self.pr_threshold,self.sample_x_shift,self.sample_y_shift,self.lat,self.sample_press_time))
        self.data_file.close()
    ...
    def set_new_trial_configuration(self):
        ...
        self.add_widget(self.initiation_image_wid)
        if self.threshold_index > self.threshold_raise_max:
            self.block_hold()
    ...
    def block_hold(self,*args):
        ...
        if self.reward_list_index >= len(self.reward_list):
            ...
            return
        self.current_reward_size = self.reward_list[self.reward_list_index]
...
class Experiment_App(App):
    def build(self):
        experiment = Experiment_Staging(session_max = self.session_max,reward_type=self.reward_type,id_entry=self.id_entry)
        return experiment
    def set(self,session_max,reward_type,id_entry):
