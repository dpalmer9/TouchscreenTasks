...
class Experiment_Staging(FloatLayout):
    ...
    def trial_presentation(self):
        ...
        self.correct_image_wid.bind(on_press = lambda new_stage: self.stage_shift(new_stage=9))
        ...
        self.incorrect_image_wid.bind(on_press = lambda new_stage: self.stage_shift(new_stage=8))
